    ...
    return (
        <Grid>
            ...
            <Grid container style={{margin: '40px 8px 20px 8px'}}>
                ...
                <Grid size={6} style={{textAlign: 'right'}}><Button className="float-right" variant="contained" color="primary" onClick={props.registerMoreCallback}>Meld på flere</Button></Grid>
            </Grid>
        </Grid>
    )
}
